// Function : FUN_400d4be8
// Address  : 0x400d4be8
// Size     : 221 bytes


undefined4 FUN_400d4be8(int *param_1)
...
LAB_400d4c01:
  do {
    iVar2 = (*(code *)&LAB_40183c7b_1)(param_1);
    *(undefined1 *)((int)param_1 + 0x1d) = 0;
    if (iVar1 == iVar2) {
      uVar5 = 4;
    ...
    if (iVar2 == 0x5c) {
      uVar3 = (*(code *)&LAB_40183c7b_1)(param_1,0x5c);
      if (uVar3 == 0) {
        return 2;
      }
      ...
      if (uVar3 == 0x75) {
        *(undefined1 *)((int)param_1 + 0x1d) = 0;
        ...
        uVar3 = 0;
        do {
          uVar4 = (*(code *)&LAB_40183c7b_1)(param_1);
          if (uVar4 == 0) {
            return 2;
          }
          if (uVar4 < 0x41) {
