...
int FUN_401022b0(undefined4 param_1,undefined4 param_2,int param_3,undefined4 param_4)
...
LAB_401022f5:
    ...
    iVar1 = FUN_4013cfac(auStack_46,0,param_4,auStack_56,param_3,param_3);
  }
  return iVar1;
}
