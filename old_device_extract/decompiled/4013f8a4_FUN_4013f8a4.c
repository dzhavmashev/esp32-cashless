...
int FUN_4013f8a4(uint *param_1,undefined1 *param_2)

{
  ...
  memw();
  iVar1 = FUN_4013f87c(param_1,&DAT_3f42261c,iVar4);
  if ((iVar1 == 0) && (iVar1 = FUN_4013f6f8(param_1,&uStack_2c,8), iVar1 == 0)) {
    if (param_1[0x1b] == 1) {
