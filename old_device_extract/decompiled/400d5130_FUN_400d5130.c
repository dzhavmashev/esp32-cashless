...
void FUN_400d5130(undefined4 *param_1,int *param_2)

{
  ...
  piVar3 = param_2;
  piVar2 = param_2;
  if ((*(byte *)((int)param_2 + 0xf) & 0x80) == 0) goto LAB_400d51ae;
  while( true ) {
    ...
    *(byte *)(param_1 + 8) = *(byte *)(param_1 + 8) & 0x80;
    ...
    puStack_68 = param_1;
    puVar1 = (undefined4 *)FUN_400d4f60(apuStack_88,param_1 + 6,0,10);
