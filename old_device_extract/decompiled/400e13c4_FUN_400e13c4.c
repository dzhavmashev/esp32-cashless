// Function : FUN_400e13c4
// Address  : 0x400e13c4
// Size     : 150 bytes


uint FUN_400e13c4(uint *param_1,int param_2,int param_3,undefined4 param_4,undefined4 param_5)

{
  ...
  if (param_1 != (uint *)0x0) {
    ...
    if ((((byte)param_1[2] & 0x20) != 0) && (uVar2 = 0, param_2 != 0)) {
      ...
      uVar2 = FUN_400e0f78(param_1,param_2,param_3,param_4,param_5);
    }
  }
  return uVar2;
}
