// Function : FUN_400f5934
// Address  : 0x400f5934
// Size     : 156 bytes


undefined4 FUN_400f5934(int param_1)

{
  ...
  if (iVar1 == 0) {
    ...
    memw();
    FUN_4012113c(1,"_enable","e",uVar2,"_enable","disable",0x77);
    uVar2 = 0x102;
  }
  else {
    ...
    if (uVar4 != 0) {
      ...
      if (puVar3 + -0xffc0000 < (uint *)0x13ffd) {
        uVar4 = (*(code *)&SUB_40094c54)("ude/hal/rtc_io_ll.h",0xb7,"down_en","io_ll.h");
      }
      memw();
      memw();
