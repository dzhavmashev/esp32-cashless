// Function : FUN_400f59d4
// Address  : 0x400f59d4
// Size     : 151 bytes


undefined4 FUN_400f59d4(int param_1)

{
  ...
  if (iVar1 == 0) {
    ...
    memw();
    FUN_4012113c(1,"_enable","e",uVar2,"_enable","_enable",0x81);
    uVar2 = 0x102;
  }
  else {
    ...
    if (uVar4 != 0) {
      ...
      if (puVar3 + -0xffc0000 < (uint *)0x13ffd) {
        uVar4 = in_t0;
        (*(code *)&SUB_40094c54)("ude/hal/rtc_io_ll.h",0xc3,"own_dis"," error\n");
      }
      memw();
      memw();
      *puVar3 = uVar4 | *puVar3;
