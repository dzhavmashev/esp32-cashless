// Function : FUN_400f3ab8
// Address  : 0x400f3ab8
// Size     : 164 bytes


undefined8 FUN_400f3ab8(int param_1,int param_2)

{
  ...
  if ((uVar1 & 1) == 0) {
    ...
    memw();
    FUN_4012113c(1,"encyMhz","hz",uVar2,"encyMhz","llup_en",0x48,"d): %s\n");
    uVar2 = 0x102;
  }
  else {
    ...
    if (param_2 == 0) {
      ...
      if (puVar3 + -0xffc0000 < (uint *)0x13ffd) {
        (*(code *)&SUB_40094c54)("ude/hal/gpio_ll.h",0x32,"lup_dis","m error");
      }
      memw();
      memw();
      *puVar3 = *puVar3 | 0x100;
