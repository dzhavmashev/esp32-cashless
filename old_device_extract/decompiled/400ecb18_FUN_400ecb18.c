...
undefined1 FUN_400ecb18(undefined4 *param_1,int param_2,undefined4 param_3)

{
  ...
  if ((*(char *)(param_1 + 1) == '\x01') && (param_2 != 0)) {
    ...
    uVar1 = FUN_400f96a8(*param_1,param_2,param_3);
    if (uVar1 == 0) {
    ...
    FUN_4012105c(pcVar5,uVar2,uVar3,uVar6,"putUInt",param_2,uVar4);
  }
  return 0;
}
